...
class Graph(models.Model):
    graph = models.ForeignKey(GraphTypes)
    ...
    def get_conf(self):
        return self.graph.conf.replace('RRDFILE', self.get_dir())


"""
CPU

DEF:idle=RRDFILE/cpu-0/cpu-idle.rrd:value:AVERAGE
...
DEF:bavg=RRDFILE/memory/memory-buffered.rrd:value:AVERAGE
...
DEF:savg=RRDFILE/load/load.rrd:shortterm:AVERAGE
